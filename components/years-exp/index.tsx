...
export const YearsExp = () => {
  return (
    <SectionWrapper className=" YearsExp">
      <GSAP />
      <Title className="mx-auto  text-[2rem] lg:text-[3.125rem] text-[#bb8866] mb-12 text-center ">
      ...
      >
        ...
        <h2 className="flex flex-col pb-7 gap-2 text-[1.8rem] md:text-[5rem] md:pb-[3.5rem] leading-none textual-context tracking-[3.5px]">
